	...
	const onSubmit = (e) => {
		...
		Axios.post(`/api/anniversaries`, {
			...
			.then((res) => {
				...
				setLoadingBtn(false)
				// Redirect to Show Anniversary
				Axios.get("api/auth").then((res2) => {
					// Set Auth
					props.setAuth(res2.data.data)
					// Push to edit page
					router.push(`/anniversaries/edit/${res.data.data.id}`)
				})
			})
			.catch((err) => {
				// Remove loader for button
	...
	return (
		<div className="row">
			...
			<div className="col-sm-8">
				<center>
					<h2 className="mb-4">Upload your Anniversary Announcement</h2>
					...
					<form
						...
						<textarea
							...
							name="description"
							className="form-control mb-2"
							placeholder="Write your anniversary announcement"
							cols="30"
							rows="5"
						...
						<Btn
							btnText="create anniversary announcement"
							loading={loadingBtn}
							disabled={loadingBtn}
						/>
						<br />
