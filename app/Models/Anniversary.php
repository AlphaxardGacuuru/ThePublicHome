...
class Anniversary extends Model
{
    ...
    protected function anniversaryDate(): Attribute
    {
        return Attribute::make(
    ...
    public function anniversaryComments()
    {
        return $this->hasMany(AnniversaryComment::class);
    }
