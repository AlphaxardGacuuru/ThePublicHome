	...
	return (
		<div className="row">
			...
			<div className="col-sm-10">
				...
				This <b>SERVICE</b> is provided to you at your cost depends the
				<b>MEMBERSHIP</b> you select and is intended for use as is. This page is
				used to inform visitors regarding my policies with the collection, use,
				...
				which is accessible at the public home unless otherwise defined in this
				Privacy Policy. Information Collection and Use For a better experience,
				...
				The information that we request will be retained on your device and is
				not collected by us in any way. The app does use third party services
				that may collect information used to identify you. Link to privacy
				policy of third party service providers used by the app Google Play
				Services Comments When visitors leave comments on the app we collect the
				data shown in the comments form, and also the visitor’s IP address and
				browser user agent string to help spam detection. Log Data we want to
				inform you that whenever you use our Service, in a case of an error in
				the app we collect data and information (through third party products)
				...
				operating system version, the configuration of the app when utilizing my
				...
				explicitly. However, the app may use third party code and libraries that
				...
				Service Providers I may employ third-party companies and individuals due
				to the following reasons: To facilitate our Service; To provide the
				Service on our behalf; To perform Service-related services; or To assist
				us in analyzing how our Service is used. We want to inform users of this
				...
				to other sites. If you click on a third-party link, you will be directed
				...
				app /websites. We have no control over and assume no responsibility for
				the content, privacy policies, or practices of any third-party sites or
				services. Children’s Privacy These Services can be used by everyone.
				Children under the age of 13 should use supported by
				<ul className="mb-0">
					<li className="mb-0">parents</li>
					<li className="mb-0">guidance</li>
					<li className="mb-0">or else</li>
				</ul>
